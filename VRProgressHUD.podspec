Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/elchief84/HTProgressHUD-2019"
  s.screenshots  = "https://raw.githubusercontent.com/elchief84/JTProgressHUD-2019/master/Screens/preview.png"

  s.license      = { :type => "MIT", :file => "LICENSE.md" }
  s.author    = "Vincenzo Romano"
  s.social_media_url   = "http://www.enzoromano.eu"
  s.platform     = :ios, "7.0"
  s.source       = { :git => "https://github.com/elchief84/HTProgressHUD-2019.git", :tag => "1.0.6" }
